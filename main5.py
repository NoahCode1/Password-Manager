def main():
     ...
     try:
        ...
        while line:
         ...
         print("the <passwordlist.txt> file is not found"
         )
     ...
     while choice !=4:
      ...
      if choice == 1:
        print("Addig a book...")
        nWebsite = input("Enter the name of the Website>")
        nEmail = input("Enter the name of the Email>")
        nPassword = input("Enter the number of the Password>")
